...
import json
import model_verb_role_joint_reverb_cnn_ft_flt_smallmlpjoin
import os
import utils
import time
import random
        ...
        for i, (id, img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbrole_joint_reverb_gttrain_cnnft_img_flt_mlpclss_small.model".format( model_name))
...
def main():
    ...
    model = model_verb_role_joint_reverb_cnn_ft_flt_smallmlpjoin.BaseModel(encoder, args.gpuid)
