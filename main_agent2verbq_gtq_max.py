        ...
        for i, (img_id, img, verb) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_agent2verbq_gtq_max.model".format( model_name))
...
def main():
    ...
    imsitu_verbq = json.load(open("imsitu_data/verb_questions_new_with_unk_agent_all3.json"))
    ...
    model = model_agent2verbq_gtq_avg.BaseModel(encoder, args.gpuid)
