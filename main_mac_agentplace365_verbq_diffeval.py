...
import json
import model_mac_agentplace365_verbq_diffeval
import os
import utils
import time
import random
        ...
        for i, (img_id, img, verb) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_mac_agentplace365_verb_td_agpred_plzpred.model".format( model_name))
...
def main():
    ...
    model = model_mac_agentplace365_verbq_diffeval.BaseModel(encoder, args.gpuid)
