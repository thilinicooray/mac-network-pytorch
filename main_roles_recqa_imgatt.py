...
import json
import model_roles_recqa_roleqa_imgatt
import os
import utils
import time
import random
        ...
        for i, (img_id, img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_roles_recqa_noself_imgatt_q.model".format( model_name))
...
def main():
    ...
    model = model_roles_recqa_roleqa_imgatt.BaseModel(encoder, args.gpuid)
