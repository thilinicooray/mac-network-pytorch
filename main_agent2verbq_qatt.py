        ...
        for i, (_id, img, verb, verbq) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_agent2verbq_td_predagent_qatt.model".format(model_name))
...
def main():
    ...
    model = model_agent2verbq_qatt.BaseModel(encoder, args.gpuid)
