        ...
        for i, (img_id, img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_roles_independent_addverbembd_newatt_onerec.model".format( model_name))
...
def main():
    ...
    model = model_roles_onerec.BaseModel(encoder, args.gpuid)
