...
import json
import model_mac_finetune_both
import os
import utils
import time
import random
...
def main():
    ...
    parser.add_argument('--noun_module', type=str, default='', help='pretrained noun module')
    ...
    parser.add_argument('--finetune_both', action='store_true', help='cnn fix, verb finetune, role finetune')
    ...
    cnn_verb_features, cnn_noun_features, verb_features, role_features = utils.group_features(model)
    ...
    optimizer = utils.get_optimizer(lr,weight_decay,optimizer_select,
                                    cnn_verb_features, cnn_noun_features, verb_features, role_features)
