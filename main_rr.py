...
import json
import recursive_recurrent_vsrl
import os
import utils
import time
import random
        ...
        for i, (_, img, verb, verbq, ans) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_context2_verb_role.model".format( model_name))
...
def main():
    ...
    model = recursive_recurrent_vsrl.BaseModel(encoder, args.gpuid)
