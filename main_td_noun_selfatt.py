        ...
        for i, (_, img, verb, roles,role_q, q_len, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_topdown_noun_roleq_selfatt.model".format( model_name))
...
def main():
    ...
    model = model_td_noun_selfatt.BaseModel(encoder, args.gpuid)
