        ...
        for i, (id, img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbq_iter0_embdhz.model".format( model_name))
...
def main():
    ...
    model = model_verbq_0_embdhz.BaseModel(encoder, args.gpuid)
    ...
    utils.set_trainable_param(model.verb_q_emb.parameters(), False)
