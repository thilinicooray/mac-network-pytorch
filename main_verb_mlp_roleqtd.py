        ...
        for i, (_, img, verb, verbq, ans) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbmlp_roletd1.model".format( model_name))
...
def main():
    ...
    model = verb_mlp_roleqtd.BaseModel(encoder, args.gpuid)
