...
import json
import model_verbq_final_deprole_joint
import os
import utils
...
def main():
    ...
    model = model_verbq_final_deprole_joint.BaseModel(encoder, args.gpuid)
    ...
    if args.evaluate:
        ...
        with open('all_pred_verbrole_joint.json', 'w') as fp:
