...
class BaseModel(nn.Module):
    def __init__(self, encoder,
        ...
        self.role_att = Attention(mlp_hidden, mlp_hidden, mlp_hidden)
    ...
    def forward(self, img, verb, labels):
        ...
        #role_values = self.role_maker(pred_rep)
        role_values = pred_rep
        ...
        role_wise_att = self.role_att(img_embed_expand, role_values)

        rolewise = role_wise_att * img_embed_expand
