...
import json
import model_verbq_fltmlp_reuseclss_gnoise
import os
import utils
import time
import random
        ...
        for i, (id, img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbq_flatmlp_reuseclss_gnoise.model".format( model_name))
...
def main():
    ...
    model = model_verbq_fltmlp_reuseclss_gnoise.BaseModel(encoder, args.gpuid)
