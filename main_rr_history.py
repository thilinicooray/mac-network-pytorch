...
def train(model, train_loader, dev_loader, traindev_loader, optimizer, scheduler, max_epoch, model_dir, encoder, gpu_mode, clip_norm, lr_max, model_name, args,eval_frequency=4000):
    ...
    for epoch in range(max_epoch):
        ...
        for i, (_, img, verb, verbq, ans) in enumerate(train_loader):
            ...
            loss = model.calculate_loss(verb_predict, verb, role_predict, ans, args)
            ...
            top1.add_point(verb_predict, verb, role_predict, ans)
            top5.add_point(verb_predict, verb, role_predict, ans)
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_context2_verb_role_history.model".format( model_name))
...
def main():
    ...
    model = recursive_rec_history.BaseModel(encoder, args.gpuid)
