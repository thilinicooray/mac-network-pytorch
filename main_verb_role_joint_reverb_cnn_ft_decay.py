...
import json
import model_verb_role_joint_reverb_cnn_ft
import os
import utils
import time
import random
        ...
        for i, (id, img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbrole_joint_reverb_gttrain_cnnft_bn_decay.model".format( model_name))
...
def main():
    ...
    model = model_verb_role_joint_reverb_cnn_ft.BaseModel(encoder, args.gpuid)
