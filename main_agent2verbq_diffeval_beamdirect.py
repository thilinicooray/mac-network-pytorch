...
import json
import model_agent2verbq_diffeval_beamdirect
import os
import utils
        ...
        for i, (_id, img, verb) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_agent2verbq_diffeval_beamdirect.model".format(model_name))
...
def main():
    ...
    model = model_agent2verbq_diffeval_beamdirect.BaseModel(encoder, args.gpuid)
