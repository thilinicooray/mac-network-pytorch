        ...
        for i, (_, img, verb, roles,labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_mac_roleread_optupdated_sampling.model".format( model_name))
...
def main():
    ...
    sampler = data_sampler.ImsituSampler(train_set, encoder.verb_list, encoder.verb_wise_items, samples_per_verb=8)
