        ...
        for i, (_, img, verb, roles,role_q, q_len, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_td_noun_diffeval.model".format( model_name))
...
def main():
    ...
    model = model_my_new_diffeval.BaseModel(encoder, args.gpuid)
