...
class BaseModel(nn.Module):
    ...
    def forward0(self, img, verbs=None, labels=None):
        ...
        return verb_pred_rep_prev, verb_pred_prev

    def forward1(self, img, verb_pred_rep_prev, verbs=None, labels=None):
    ...
    def calculate_loss_single(self, verb_pred, gt_verbs):
