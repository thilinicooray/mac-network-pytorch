        ...
        for i, (_id, img, verb, roles,labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_agent2verb_td.model".format(model_name))
...
def main():
    ...
    model = mode_agent2verbtd.BaseModel(encoder, args.gpuid)
