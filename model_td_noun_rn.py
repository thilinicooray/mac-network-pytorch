...
class BaseModel(nn.Module):
    ...
    def forward(self, img, verb, role_q):
        ...
        compared_with = compared_with.contiguous().view(-1, compared_with.size(-1))
        ...
        org_ans = org_ans.transpose(0,1)
        org_ans = org_ans.contiguous().view(batch_size* self.max_role_count*self.max_role_count, self.mlp_hidden)
