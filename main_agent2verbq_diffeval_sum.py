...
import json
import model_agent2verbq_diffeval_sum
import os
import utils
        ...
        for i, (_id, img, verb) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_agent2verbq_diffeval_sum.model".format(model_name))
...
def eval(model, dev_loader, encoder, gpu_mode, write_to_file = False):
    ...
    with torch.no_grad():
        ...
        for i, (_id, img, verb) in enumerate(dev_loader):
            ...
            val_loss += loss.item()'''
            top1.add_point_verb_only_eval(_id, verb_predict, verb)
            top5.add_point_verb_only_eval(_id, verb_predict, verb)
...
def main():
    ...
    model = model_agent2verbq_diffeval_sum.BaseModel(encoder, args.gpuid)
