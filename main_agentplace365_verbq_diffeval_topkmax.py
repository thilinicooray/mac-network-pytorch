import torch
from imsitu_encoder_agentplace365_verbq_diffeval import imsitu_encoder
from imsitu_loader import imsitu_loader_verbq_mul
from imsitu_scorer_log import imsitu_scorer
import json
import model_agentplace365_verbq_diffeval_topkmax
import os
import utils
import time
import random
        ...
        for i, (img_id, img, verb) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_agentplace365_verb_td_agpred_plzpred.model".format( model_name))
...
def eval(model, dev_loader, encoder, gpu_mode, write_to_file = False):
    ...
    all = top1.all_res
    logit_info = model.selected_agents
...
def main():
    ...
    model = model_agentplace365_verbq_diffeval_topkmax.BaseModel(encoder, args.gpuid)
