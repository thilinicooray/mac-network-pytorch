...
import json
import model_verbmlp_roleq_cln
import os
import utils
import time
import random
        ...
        for i, (_, img, verb, verbq, ans) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbmlp_roleq_cln.model".format( model_name))
...
def main():
    ...
    model = model_verbmlp_roleq_cln.BaseModel(encoder, args.gpuid)
    ...
    if args.train_role:
        ...
        optimizer_set = utils.get_optimizer_single(lr,weight_decay,optimizer_select,
